...
var viewerPlayerglobalInfo = {
  abcs: "../playerglobal/playerglobal.abcs",
  catalog: "../playerglobal/playerglobal.json"
};

function runViewer(url) {
  FileLoadingService.setBaseUrl(SHUMWAY_ROOT);
  parseSwf(url, {}, {}, {
    sysCompiler: true,
    appCompiler: true,
    verifier: true,
  ...
  createAVM2(builtinPath, viewerPlayerglobalInfo, avm1Path,
    ...
    function (avm2) {
      ...
      SWF.embed(url, document, document.getElementById("viewer"), {
         ...
         onComplete: qwop.onLoad,
         onBeforeFrame: qwop.frameHandler,
         onStageInitialized: qwop.onStageInitialized
      });
  });
}
